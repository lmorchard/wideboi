...
| Scrolling, 80×24, 1 client | 30.30 | 13,527 B | 405,810 B (30 full snapshots) | 405,810 B | 0% |
...
which supports the server's full-snapshot fallback for scrolling. Complete
