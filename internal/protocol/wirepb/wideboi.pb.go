...
func (x *MsgPaneMetadata) GetExited() bool {
	if x != nil {
		return x.Exited
	}
	return false
...
func (x *MsgPaneMetadata) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
type ServerMessage struct {
	...
	//	*ServerMessage_FocusPane
	//	*ServerMessage_SplitResponse
	//	*ServerMessage_SendInputResponse
	//	*ServerMessage_CaptureResponse
...
func (x *ServerMessage) GetFocusPane() *MsgFocusPane {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_FocusPane); ok {
			return x.FocusPane
		}
	}
	return nil
...
func (x *ServerMessage) GetSplitResponse() *MsgSplitResponse {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_SplitResponse); ok {
			return x.SplitResponse
		}
	}
	return nil
}

func (x *ServerMessage) GetSendInputResponse() *MsgSendInputResponse {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_SendInputResponse); ok {
			return x.SendInputResponse
		}
	}
	return nil
}

func (x *ServerMessage) GetCaptureResponse() *MsgCaptureResponse {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_CaptureResponse); ok {
...
func (x *ServerMessage) GetClosePaneResponse() *MsgClosePaneResponse {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_ClosePaneResponse); ok {
			return x.ClosePaneResponse
		}
	}
	return nil
}

func (x *ServerMessage) GetHistorySnapshot() *MsgHistorySnapshot {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_HistorySnapshot); ok {
...
func (x *ServerMessage) GetWaitResponse() *MsgWaitResponse {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_WaitResponse); ok {
			return x.WaitResponse
		}
	}
	return nil
}
...
func (x *ServerMessage) GetUpgradeResponse() *MsgUpgradeResponse {
	if x != nil {
		if x, ok := x.Msg.(*ServerMessage_UpgradeResponse); ok {
...
type ServerMessage_FocusPane struct {
	FocusPane *MsgFocusPane `protobuf:"bytes,8,opt,name=focus_pane,json=focusPane,proto3,oneof"`
}

type ServerMessage_SplitResponse struct {
	SplitResponse *MsgSplitResponse `protobuf:"bytes,9,opt,name=split_response,json=splitResponse,proto3,oneof"`
}

type ServerMessage_SendInputResponse struct {
	SendInputResponse *MsgSendInputResponse `protobuf:"bytes,10,opt,name=send_input_response,json=sendInputResponse,proto3,oneof"`
}

type ServerMessage_CaptureResponse struct {
	CaptureResponse *MsgCaptureResponse `protobuf:"bytes,11,opt,name=capture_response,json=captureResponse,proto3,oneof"`
}

type ServerMessage_ClosePaneResponse struct {
	ClosePaneResponse *MsgClosePaneResponse `protobuf:"bytes,12,opt,name=close_pane_response,json=closePaneResponse,proto3,oneof"`
}

type ServerMessage_HistorySnapshot struct {
	HistorySnapshot *MsgHistorySnapshot `protobuf:"bytes,13,opt,name=history_snapshot,json=historySnapshot,proto3,oneof"`
}

type ServerMessage_WaitResponse struct {
...
type ServerMessage_UpgradeResponse struct {
	UpgradeResponse *MsgUpgradeResponse `protobuf:"bytes,16,opt,name=upgrade_response,json=upgradeResponse,proto3,oneof"`
}
...
func (*ServerMessage_FocusPane) isServerMessage_Msg() {}

func (*ServerMessage_SplitResponse) isServerMessage_Msg() {}

func (*ServerMessage_SendInputResponse) isServerMessage_Msg() {}

func (*ServerMessage_CaptureResponse) isServerMessage_Msg() {}

func (*ServerMessage_ClosePaneResponse) isServerMessage_Msg() {}
...
type MsgVerb struct {
	...
	Widths        map[int32]int32        `protobuf:"bytes,3,rep,name=widths,proto3" json:"widths,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MsgVerb) GetWidths() map[int32]int32 {
	if x != nil {
		return x.Widths
	}
	return nil
...
func (x *MsgSetPaneWidth) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgSetPaneWidth) GetWidth() int32 {
	if x != nil {
		return x.Width
	}
	return 0
...
func (x *MsgScroll) GetSetAbsolute() bool {
	if x != nil {
		return x.SetAbsolute
	}
	return false
}
...
func (x *MsgHistoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type MsgHistorySnapshot struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PaneId        int32                  `protobuf:"varint,1,opt,name=pane_id,json=paneId,proto3" json:"pane_id,omitempty"`
	ScrollbackLen int32                  `protobuf:"varint,2,opt,name=scrollback_len,json=scrollbackLen,proto3" json:"scrollback_len,omitempty"`
...
func (x *MsgHistorySnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgHistorySnapshot) GetScrollbackLen() int32 {
	if x != nil {
		return x.ScrollbackLen
	}
	return 0
...
func (x *MsgHistorySnapshot) GetRows() []string {
	if x != nil {
		return x.Rows
	}
	return nil
...
type ClientMessage struct {
	...
	//	*ClientMessage_SplitRequest
	//	*ClientMessage_SendInputRequest
	//	*ClientMessage_CaptureRequest
	//	*ClientMessage_ClosePaneRequest
...
func (x *ClientMessage) GetSplitRequest() *MsgSplitRequest {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_SplitRequest); ok {
...
func (x *ClientMessage) GetSendInputRequest() *MsgSendInputRequest {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_SendInputRequest); ok {
			return x.SendInputRequest
		}
	}
	return nil
}

func (x *ClientMessage) GetCaptureRequest() *MsgCaptureRequest {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_CaptureRequest); ok {
...
func (x *ClientMessage) GetClosePaneRequest() *MsgClosePaneRequest {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_ClosePaneRequest); ok {
			return x.ClosePaneRequest
		}
	}
	return nil
}

func (x *ClientMessage) GetHistoryRequest() *MsgHistoryRequest {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_HistoryRequest); ok {
...
func (x *ClientMessage) GetWaitRequest() *MsgWaitRequest {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_WaitRequest); ok {
			return x.WaitRequest
		}
	}
	return nil
}

func (x *ClientMessage) GetSetPaneWidth() *MsgSetPaneWidth {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_SetPaneWidth); ok {
			return x.SetPaneWidth
		}
	}
	return nil
}
...
func (x *ClientMessage) GetUpgradeRequest() *MsgUpgradeRequest {
	if x != nil {
		if x, ok := x.Msg.(*ClientMessage_UpgradeRequest); ok {
...
type ClientMessage_SplitRequest struct {
	SplitRequest *MsgSplitRequest `protobuf:"bytes,12,opt,name=split_request,json=splitRequest,proto3,oneof"`
}

type ClientMessage_SendInputRequest struct {
	SendInputRequest *MsgSendInputRequest `protobuf:"bytes,13,opt,name=send_input_request,json=sendInputRequest,proto3,oneof"`
}

type ClientMessage_CaptureRequest struct {
	CaptureRequest *MsgCaptureRequest `protobuf:"bytes,14,opt,name=capture_request,json=captureRequest,proto3,oneof"`
}

type ClientMessage_ClosePaneRequest struct {
	ClosePaneRequest *MsgClosePaneRequest `protobuf:"bytes,15,opt,name=close_pane_request,json=closePaneRequest,proto3,oneof"`
}

type ClientMessage_HistoryRequest struct {
	HistoryRequest *MsgHistoryRequest `protobuf:"bytes,16,opt,name=history_request,json=historyRequest,proto3,oneof"`
}

type ClientMessage_WaitRequest struct {
	WaitRequest *MsgWaitRequest `protobuf:"bytes,17,opt,name=wait_request,json=waitRequest,proto3,oneof"`
}

type ClientMessage_SetPaneWidth struct {
...
type ClientMessage_UpgradeRequest struct {
	UpgradeRequest *MsgUpgradeRequest `protobuf:"bytes,20,opt,name=upgrade_request,json=upgradeRequest,proto3,oneof"`
}
...
func (*ClientMessage_SplitRequest) isClientMessage_Msg() {}

func (*ClientMessage_SendInputRequest) isClientMessage_Msg() {}

func (*ClientMessage_CaptureRequest) isClientMessage_Msg() {}

func (*ClientMessage_ClosePaneRequest) isClientMessage_Msg() {}

func (*ClientMessage_HistoryRequest) isClientMessage_Msg() {}
...
func (x *MsgUpgradeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgUpgradeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgWaitRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgWaitResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgWaitResponse) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
func (x *MsgWaitResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type MsgSplitRequest struct {
	...
	Cwd           string                 `protobuf:"bytes,2,opt,name=cwd,proto3" json:"cwd,omitempty"`
	AfterPaneId   int32                  `protobuf:"varint,3,opt,name=after_pane_id,json=afterPaneId,proto3" json:"after_pane_id,omitempty"`
...
func (x *MsgSplitRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgSplitRequest) GetCwd() string {
	if x != nil {
		return x.Cwd
	}
	return ""
...
func (x *MsgSplitRequest) GetAfterPaneId() int32 {
	if x != nil {
		return x.AfterPaneId
	}
	return 0
}

func (x *MsgSplitRequest) GetKeep() bool {
	if x != nil {
		return x.Keep
	}
	return false
...
func (x *MsgSplitResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgSplitResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *MsgSendInputRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgSendInputRequest) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *MsgSendInputResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgSendInputResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *MsgCaptureRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgCaptureRequest) GetScrollback() bool {
	if x != nil {
		return x.Scrollback
	}
	return false
...
func (x *MsgCaptureRequest) GetLines() int32 {
	if x != nil {
		return x.Lines
	}
	return 0
...
func (x *MsgCaptureResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgCaptureResponse) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *MsgCaptureResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *MsgClosePaneRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgClosePaneResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgClosePaneResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
const file_internal_protocol_wirepb_wideboi_proto_rawDesc = "" +
	...
	"\texit_code\x18\x02 \x01(\x05R\bexitCode\"\xfc\x01\n" +
	"\x0fMsgPaneMetadata\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x10\n" +
	"\x03cwd\x18\x02 \x01(\tR\x03cwd\x12L\n" +
	"\tuser_vars\x18\x03 \x03(\v2/.wideboi.protocol.MsgPaneMetadata.UserVarsEntryR\buserVars\x12\x16\n" +
	"\x06exited\x18\x04 \x01(\bR\x06exited\x12\x1b\n" +
	"\texit_code\x18\x05 \x01(\x05R\bexitCode\x1a;\n" +
	"\rUserVarsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"'\n" +
	"\fMsgFocusPane\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\"\xdf\t\n" +
	"\rServerMessage\x12B\n" +
	...
	"\rtraffic_stats\x18\a \x01(\v2!.wideboi.protocol.MsgTrafficStatsH\x00R\ftrafficStats\x12?\n" +
	"\n" +
	"focus_pane\x18\b \x01(\v2\x1e.wideboi.protocol.MsgFocusPaneH\x00R\tfocusPane\x12K\n" +
	"\x0esplit_response\x18\t \x01(\v2\".wideboi.protocol.MsgSplitResponseH\x00R\rsplitResponse\x12X\n" +
	"\x13send_input_response\x18\n" +
	" \x01(\v2&.wideboi.protocol.MsgSendInputResponseH\x00R\x11sendInputResponse\x12Q\n" +
	...
	"\x10upgrade_response\x18\x10 \x01(\v2$.wideboi.protocol.MsgUpgradeResponseH\x00R\x0fupgradeResponseB\x05\n" +
	"\x03msg\"3\n" +
	"\tMsgAttach\x12\x12\n" +
	"\x04cols\x18\x01 \x01(\x05R\x04cols\x12\x12\n" +
	"\x04rows\x18\x02 \x01(\x05R\x04rows\"\xcc\x01\n" +
	"\aMsgVerb\x12.\n" +
	"\x04verb\x18\x01 \x01(\x0e2\x1a.wideboi.protocol.VerbTypeR\x04verb\x12\x17\n" +
	"\apane_id\x18\x02 \x01(\x05R\x06paneId\x12=\n" +
	"\x06widths\x18\x03 \x03(\v2%.wideboi.protocol.MsgVerb.WidthsEntryR\x06widths\x1a9\n" +
	"\vWidthsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"@\n" +
	"\x0fMsgSetPaneWidth\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x14\n" +
	"\x05width\x18\x02 \x01(\x05R\x05width\"\x9a\x01\n" +
	"\bMsgMouse\x12\x17\n" +
	...
	"\x0ftraffic_request\x18\v \x01(\v2#.wideboi.protocol.MsgTrafficRequestH\x00R\x0etrafficRequest\x12H\n" +
	"\rsplit_request\x18\f \x01(\v2!.wideboi.protocol.MsgSplitRequestH\x00R\fsplitRequest\x12U\n" +
	"\x12send_input_request\x18\r \x01(\v2%.wideboi.protocol.MsgSendInputRequestH\x00R\x10sendInputRequest\x12N\n" +
	"\x0fcapture_request\x18\x0e \x01(\v2#.wideboi.protocol.MsgCaptureRequestH\x00R\x0ecaptureRequest\x12U\n" +
	...
	"saveMacros\x12N\n" +
	"\x0fupgrade_request\x18\x14 \x01(\v2#.wideboi.protocol.MsgUpgradeRequestH\x00R\x0eupgradeRequestB\x05\n" +
	"\x03msg\".\n" +
	...
	"\x0fMsgWaitResponse\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x1b\n" +
	"\texit_code\x18\x02 \x01(\x05R\bexitCode\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"u\n" +
	"\x0fMsgSplitRequest\x12\x18\n" +
	"\acommand\x18\x01 \x01(\tR\acommand\x12\x10\n" +
	"\x03cwd\x18\x02 \x01(\tR\x03cwd\x12\"\n" +
	"\rafter_pane_id\x18\x03 \x01(\x05R\vafterPaneId\x12\x12\n" +
	"\x04keep\x18\x04 \x01(\bR\x04keep\"A\n" +
	"\x10MsgSplitResponse\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\"B\n" +
	"\x13MsgSendInputRequest\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\"E\n" +
	"\x14MsgSendInputResponse\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\"b\n" +
	"\x11MsgCaptureRequest\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x1e\n" +
	"\n" +
	"scrollback\x18\x02 \x01(\bR\n" +
	"scrollback\x12\x14\n" +
	"\x05lines\x18\x03 \x01(\x05R\x05lines\"W\n" +
	"\x12MsgCaptureResponse\x12\x17\n" +
	"\apane_id\x18\x01 \x01(\x05R\x06paneId\x12\x12\n" +
...
var file_internal_protocol_wirepb_wideboi_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_internal_protocol_wirepb_wideboi_proto_goTypes = []any{
	...
	(*MsgFocusPane)(nil),         // 16: wideboi.protocol.MsgFocusPane
	(*ServerMessage)(nil),        // 17: wideboi.protocol.ServerMessage
	(*MsgAttach)(nil),            // 18: wideboi.protocol.MsgAttach
	(*MsgVerb)(nil),              // 19: wideboi.protocol.MsgVerb
	(*MsgSetPaneWidth)(nil),      // 20: wideboi.protocol.MsgSetPaneWidth
	(*MsgMouse)(nil),             // 21: wideboi.protocol.MsgMouse
	(*KeyData)(nil),              // 22: wideboi.protocol.KeyData
	(*MsgInput)(nil),             // 23: wideboi.protocol.MsgInput
	(*MsgResize)(nil),            // 24: wideboi.protocol.MsgResize
	(*MsgScroll)(nil),            // 25: wideboi.protocol.MsgScroll
	(*MsgHistoryRequest)(nil),    // 26: wideboi.protocol.MsgHistoryRequest
	(*MsgHistorySnapshot)(nil),   // 27: wideboi.protocol.MsgHistorySnapshot
	(*MsgPaneResync)(nil),        // 28: wideboi.protocol.MsgPaneResync
	(*MsgDetach)(nil),            // 29: wideboi.protocol.MsgDetach
	(*MsgShutdown)(nil),          // 30: wideboi.protocol.MsgShutdown
	(*MsgStatusRequest)(nil),     // 31: wideboi.protocol.MsgStatusRequest
	(*ClientMessage)(nil),        // 32: wideboi.protocol.ClientMessage
	(*MsgUpgradeRequest)(nil),    // 33: wideboi.protocol.MsgUpgradeRequest
	(*MsgUpgradeResponse)(nil),   // 34: wideboi.protocol.MsgUpgradeResponse
	(*MsgWaitRequest)(nil),       // 35: wideboi.protocol.MsgWaitRequest
	(*MsgWaitResponse)(nil),      // 36: wideboi.protocol.MsgWaitResponse
	(*MsgSplitRequest)(nil),      // 37: wideboi.protocol.MsgSplitRequest
	(*MsgSplitResponse)(nil),     // 38: wideboi.protocol.MsgSplitResponse
	(*MsgSendInputRequest)(nil),  // 39: wideboi.protocol.MsgSendInputRequest
	(*MsgSendInputResponse)(nil), // 40: wideboi.protocol.MsgSendInputResponse
	(*MsgCaptureRequest)(nil),    // 41: wideboi.protocol.MsgCaptureRequest
	(*MsgCaptureResponse)(nil),   // 42: wideboi.protocol.MsgCaptureResponse
	(*MsgClosePaneRequest)(nil),  // 43: wideboi.protocol.MsgClosePaneRequest
	(*MsgClosePaneResponse)(nil), // 44: wideboi.protocol.MsgClosePaneResponse
	(*MsgTrafficRequest)(nil),    // 45: wideboi.protocol.MsgTrafficRequest
	(*TimingStat)(nil),           // 46: wideboi.protocol.TimingStat
	(*ClientTraffic)(nil),        // 47: wideboi.protocol.ClientTraffic
	(*MsgTrafficStats)(nil),      // 48: wideboi.protocol.MsgTrafficStats
	(*MacroStep)(nil),            // 49: wideboi.protocol.MacroStep
	(*Macro)(nil),                // 50: wideboi.protocol.Macro
	(*MsgMacrosSnapshot)(nil),    // 51: wideboi.protocol.MsgMacrosSnapshot
	(*MsgSaveMacros)(nil),        // 52: wideboi.protocol.MsgSaveMacros
	nil,                          // 53: wideboi.protocol.MsgLayoutSnapshot.PaneStatusesEntry
	nil,                          // 54: wideboi.protocol.MsgLayoutSnapshot.PaneTitlesEntry
	nil,                          // 55: wideboi.protocol.MsgPaneMetadata.UserVarsEntry
	nil,                          // 56: wideboi.protocol.MsgVerb.WidthsEntry
}
var file_internal_protocol_wirepb_wideboi_proto_depIdxs = []int32{
	...
	53, // 10: wideboi.protocol.MsgLayoutSnapshot.pane_statuses:type_name -> wideboi.protocol.MsgLayoutSnapshot.PaneStatusesEntry
	54, // 11: wideboi.protocol.MsgLayoutSnapshot.pane_titles:type_name -> wideboi.protocol.MsgLayoutSnapshot.PaneTitlesEntry
	55, // 12: wideboi.protocol.MsgPaneMetadata.user_vars:type_name -> wideboi.protocol.MsgPaneMetadata.UserVarsEntry
	...
	48, // 19: wideboi.protocol.ServerMessage.traffic_stats:type_name -> wideboi.protocol.MsgTrafficStats
	16, // 20: wideboi.protocol.ServerMessage.focus_pane:type_name -> wideboi.protocol.MsgFocusPane
	38, // 21: wideboi.protocol.ServerMessage.split_response:type_name -> wideboi.protocol.MsgSplitResponse
	40, // 22: wideboi.protocol.ServerMessage.send_input_response:type_name -> wideboi.protocol.MsgSendInputResponse
	42, // 23: wideboi.protocol.ServerMessage.capture_response:type_name -> wideboi.protocol.MsgCaptureResponse
	44, // 24: wideboi.protocol.ServerMessage.close_pane_response:type_name -> wideboi.protocol.MsgClosePaneResponse
	27, // 25: wideboi.protocol.ServerMessage.history_snapshot:type_name -> wideboi.protocol.MsgHistorySnapshot
	36, // 26: wideboi.protocol.ServerMessage.wait_response:type_name -> wideboi.protocol.MsgWaitResponse
	51, // 27: wideboi.protocol.ServerMessage.macros_snapshot:type_name -> wideboi.protocol.MsgMacrosSnapshot
	34, // 28: wideboi.protocol.ServerMessage.upgrade_response:type_name -> wideboi.protocol.MsgUpgradeResponse
	0,  // 29: wideboi.protocol.MsgVerb.verb:type_name -> wideboi.protocol.VerbType
	56, // 30: wideboi.protocol.MsgVerb.widths:type_name -> wideboi.protocol.MsgVerb.WidthsEntry
	3,  // 31: wideboi.protocol.MsgMouse.kind:type_name -> wideboi.protocol.MouseKind
	22, // 32: wideboi.protocol.MsgInput.key:type_name -> wideboi.protocol.KeyData
	18, // 33: wideboi.protocol.ClientMessage.attach:type_name -> wideboi.protocol.MsgAttach
	19, // 34: wideboi.protocol.ClientMessage.verb:type_name -> wideboi.protocol.MsgVerb
	21, // 35: wideboi.protocol.ClientMessage.mouse:type_name -> wideboi.protocol.MsgMouse
	23, // 36: wideboi.protocol.ClientMessage.input:type_name -> wideboi.protocol.MsgInput
	24, // 37: wideboi.protocol.ClientMessage.resize:type_name -> wideboi.protocol.MsgResize
	25, // 38: wideboi.protocol.ClientMessage.scroll:type_name -> wideboi.protocol.MsgScroll
	28, // 39: wideboi.protocol.ClientMessage.pane_resync:type_name -> wideboi.protocol.MsgPaneResync
	29, // 40: wideboi.protocol.ClientMessage.detach:type_name -> wideboi.protocol.MsgDetach
	30, // 41: wideboi.protocol.ClientMessage.shutdown:type_name -> wideboi.protocol.MsgShutdown
	31, // 42: wideboi.protocol.ClientMessage.status_request:type_name -> wideboi.protocol.MsgStatusRequest
	45, // 43: wideboi.protocol.ClientMessage.traffic_request:type_name -> wideboi.protocol.MsgTrafficRequest
	37, // 44: wideboi.protocol.ClientMessage.split_request:type_name -> wideboi.protocol.MsgSplitRequest
	39, // 45: wideboi.protocol.ClientMessage.send_input_request:type_name -> wideboi.protocol.MsgSendInputRequest
	41, // 46: wideboi.protocol.ClientMessage.capture_request:type_name -> wideboi.protocol.MsgCaptureRequest
	43, // 47: wideboi.protocol.ClientMessage.close_pane_request:type_name -> wideboi.protocol.MsgClosePaneRequest
	26, // 48: wideboi.protocol.ClientMessage.history_request:type_name -> wideboi.protocol.MsgHistoryRequest
	35, // 49: wideboi.protocol.ClientMessage.wait_request:type_name -> wideboi.protocol.MsgWaitRequest
	20, // 50: wideboi.protocol.ClientMessage.set_pane_width:type_name -> wideboi.protocol.MsgSetPaneWidth
	52, // 51: wideboi.protocol.ClientMessage.save_macros:type_name -> wideboi.protocol.MsgSaveMacros
	33, // 52: wideboi.protocol.ClientMessage.upgrade_request:type_name -> wideboi.protocol.MsgUpgradeRequest
	46, // 53: wideboi.protocol.ClientTraffic.encode:type_name -> wideboi.protocol.TimingStat
	47, // 54: wideboi.protocol.MsgTrafficStats.clients:type_name -> wideboi.protocol.ClientTraffic
	47, // 55: wideboi.protocol.MsgTrafficStats.departed:type_name -> wideboi.protocol.ClientTraffic
	46, // 56: wideboi.protocol.MsgTrafficStats.render:type_name -> wideboi.protocol.TimingStat
	46, // 57: wideboi.protocol.MsgTrafficStats.build_patch:type_name -> wideboi.protocol.TimingStat
	49, // 58: wideboi.protocol.Macro.steps:type_name -> wideboi.protocol.MacroStep
	50, // 59: wideboi.protocol.MsgMacrosSnapshot.macros:type_name -> wideboi.protocol.Macro
	50, // 60: wideboi.protocol.MsgSaveMacros.macros:type_name -> wideboi.protocol.Macro
	1,  // 61: wideboi.protocol.MsgLayoutSnapshot.PaneStatusesEntry.value:type_name -> wideboi.protocol.PaneStatus
...
func file_internal_protocol_wirepb_wideboi_proto_init() {
	...
	file_internal_protocol_wirepb_wideboi_proto_msgTypes[13].OneofWrappers = []any{
		...
		(*ServerMessage_FocusPane)(nil),
		(*ServerMessage_SplitResponse)(nil),
		(*ServerMessage_SendInputResponse)(nil),
		(*ServerMessage_CaptureResponse)(nil),
	...
	file_internal_protocol_wirepb_wideboi_proto_msgTypes[28].OneofWrappers = []any{
		...
		(*ClientMessage_SplitRequest)(nil),
		(*ClientMessage_SendInputRequest)(nil),
		(*ClientMessage_CaptureRequest)(nil),
		(*ClientMessage_ClosePaneRequest)(nil),
